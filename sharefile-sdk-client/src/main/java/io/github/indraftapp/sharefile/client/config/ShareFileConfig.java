 ...
 *
 * <p>Holds connection settings, timeouts, and the computed base API URL. Create instances via the
 * {@link Builder}:
 *
 * <pre>{@code
...
public final class ShareFileConfig {
  ...
  /** Returns the token endpoint URL, e.g. {@code https://mycompany.sharefile.com/oauth/token}. */
  ...
  public static final class Builder {
     ...
     *
     * <p>The token will be refreshed proactively when 80% of the {@code expires_in} duration has
     * elapsed.
     *
