...
/**
 * Represents the outcome of a ShareFile operation that may complete immediately or continue
 * asynchronously.
 *
...
public sealed interface OperationResult<T> {
  ...
  /**
   * Returns the completed entity or throws when the server responded with an asynchronous operation
   * instead.
   *
