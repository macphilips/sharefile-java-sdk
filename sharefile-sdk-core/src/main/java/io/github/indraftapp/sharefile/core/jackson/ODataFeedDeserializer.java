...
final class ODataFeedDeserializer extends StdDeserializer<ODataFeed<?>> implements ContextualDeserializer {
    ...
    @Override
    public ODataFeed<?> deserialize(JsonParser parser, DeserializationContext context) throws IOException {
    ...
    @Override
    public ODataFeedDeserializer createContextual(DeserializationContext context, BeanProperty property) {
