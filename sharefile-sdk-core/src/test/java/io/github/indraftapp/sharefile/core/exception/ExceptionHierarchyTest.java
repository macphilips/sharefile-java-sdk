...
/**
 * SF-03: Verify every exception can be created and its fields are accessible via getters. Also
...
class ExceptionHierarchyTest {
  ...
  void shareFileApiException_fieldsAccessible() {
    var ex =
        new ShareFileApiException(
            500, "ServerError", "Internal failure", "req-123", "GET", "/sf/v3/Items(id)");
  ...
  void shareFileApiException_withCause() {
    ...
    var ex =
        new ShareFileApiException(
            502, "BadGateway", "upstream timeout", "req-456", "POST", "/sf/v3/Items", cause);
  ...
  void shareFileNotFoundException_fixedStatus404() {
    var ex =
        new ShareFileNotFoundException(
            "NotFound", "Item not found", "req-1", "GET", "/sf/v3/Items(id)");
  ...
  void shareFileBadRequestException_fixedStatus400() {
    var ex =
        new ShareFileBadRequestException(
            "BadRequest", "Invalid param", "req-2", "POST", "/sf/v3/Items");
  ...
  void shareFileUnauthorizedException_fixedStatus401() {
    var ex =
        new ShareFileUnauthorizedException(
            "Unauthorized", "Token expired", "req-3", "GET", "/sf/v3/Users");
  ...
  void shareFileForbiddenException_fixedStatus403() {
    var ex =
        new ShareFileForbiddenException(
            "Forbidden", "Access denied", "req-4", "DELETE", "/sf/v3/Items(id)");
  ...
  void shareFileConflictException_fixedStatus409() {
    var ex =
        new ShareFileConflictException(
            "Conflict", "Already exists", "req-5", "POST", "/sf/v3/Items");
  ...
  void shareFileRateLimitException_fixedStatus429_withRetryAfter() {
    var ex =
        new ShareFileRateLimitException(
            "RateLimit", "Too many requests", "req-6", "GET", "/sf/v3/Items", 30);
  ...
  void shareFileServerException_variableStatus() {
    var ex =
        new ShareFileServerException(
            503, "ServiceUnavailable", "Maintenance", "req-7", "GET", "/sf/v3/Items");
  ...
  void shareFileServerException_withCause() {
    ...
    var ex =
        new ShareFileServerException(
            502, "BadGateway", "Upstream failed", "req-8", "POST", "/sf/v3/Items", cause);
